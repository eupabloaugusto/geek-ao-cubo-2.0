...
$categoria   = isset( $args['categoria'] ) ? esc_html( $args['categoria'] ) : __( 'Geral', 'geek-ao-cubo' );
$autor       = isset( $args['autor'] ) ? esc_html( $args['autor'] ) : __( 'Redação', 'geek-ao-cubo' );
...
<a href="<?php echo $url; ?>" class="<?php echo esc_attr( $classes ); ?>" aria-label="<?php echo esc_attr( sprintf( __( 'Leia mais sobre: %s', 'geek-ao-cubo' ), $titulo ) ); ?>">
	...
	<div class="card-noticia__media-wrapper">
		<?php if ( ! empty( $imagem_url ) ) : ?>
			<img src="<?php echo $imagem_url; ?>" 
			     alt="<?php echo esc_attr( sprintf( __( 'Capa de: %s', 'geek-ao-cubo' ), $titulo ) ); ?>" 
		...
		<div class="card-noticia__footer">
			<div class="card-noticia__meta">
				...
				<span class="card-noticia__meta-item card-noticia__author">
					...
					<?php printf( __( 'por %s', 'geek-ao-cubo' ), $autor ); ?>
				</span>
