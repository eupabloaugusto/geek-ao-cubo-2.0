...
?>
<div class="carousel-nav" <?php echo $carousel_id ? 'data-target="' . $carousel_id . '"' : ''; ?> role="group" aria-label="<?php esc_attr_e( 'Controles de navegação do carrossel', 'geek-ao-cubo' ); ?>">
