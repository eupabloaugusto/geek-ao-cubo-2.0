			...
			<div class="review-card__meta">
				<?php if ( ! empty( $reviewer_url ) ) : ?>
					<a
						...
						rel="nofollow"
						aria-label="<?php echo esc_attr( sprintf( __( 'Ver perfil de %s', 'geek-ao-cubo' ), $reviewer_name ) ); ?>"
						itemprop="author"
						itemscope
		...
		<footer class="review-card__footer">
			...
			<?php if ( $is_expandable ) : ?>
				<button
					...
					data-label-more="<?php echo esc_attr( __( 'Ler mais', 'geek-ao-cubo' ) ); ?>"
					data-label-less="<?php echo esc_attr( __( 'Ler menos', 'geek-ao-cubo' ) ); ?>"
				>
					<span class="review-card__toggle-label"><?php _e( 'Ler mais', 'geek-ao-cubo' ); ?></span>
			...
			<?php if ( ! empty( $review_url ) ) : ?>
				<a
					...
					target="_blank"
					aria-label="<?php echo esc_attr( sprintf( __( 'Ver review completa de %s', 'geek-ao-cubo' ), $reviewer_name ) ); ?>"
				>
					<?php _e( 'Ver review completa', 'geek-ao-cubo' ); ?>
