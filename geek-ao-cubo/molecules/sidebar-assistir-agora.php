...
$title         = isset( $args['title'] ) ? esc_html( $args['title'] ) : __( 'ASSISTA AGORA', 'geek-ao-cubo' );
$platform_name = isset( $args['platform_name'] ) ? esc_html( $args['platform_name'] ) : 'Crunchyroll';
$description   = isset( $args['description'] ) ? esc_html( $args['description'] ) : __( 'Temporadas completas com dublagem e legendas em português.', 'geek-ao-cubo' );
	...
	<div class="sidebar-assistir-agora__content">
		...
		<div class="sidebar-assistir-agora__action">
			...
			mm_render_component( 'atoms', 'btn-primary', array(
				'label' => sprintf( __( 'Assistir na %s', 'geek-ao-cubo' ), $platform_name ),
				'url'   => $stream_url,
