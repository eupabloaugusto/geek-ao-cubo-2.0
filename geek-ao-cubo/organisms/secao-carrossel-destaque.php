...
?>
<section class="secao-carrossel-destaque js-carousel-container" id="<?php echo esc_attr( $carousel_id ); ?>" aria-label="<?php esc_attr_e( 'Carrossel de Notícias em Destaque', 'geek-ao-cubo' ); ?>">
