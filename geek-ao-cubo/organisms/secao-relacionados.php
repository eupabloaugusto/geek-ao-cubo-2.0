...
$titulo = isset( $args['titulo'] ) ? esc_html( $args['titulo'] ) : __( 'Conteúdo Relacionado', 'geek-ao-cubo' );
...
foreach ( $items as $item ) {
	...
	$relation = ! empty( $item['relation_type'] ) ? esc_html( $item['relation_type'] ) : __( 'Outros', 'geek-ao-cubo' );
