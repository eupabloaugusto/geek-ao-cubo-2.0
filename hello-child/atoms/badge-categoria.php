...
?>
<a href="<?php echo $url; ?>" class="badge-categoria <?php echo $theme_class; ?> <?php echo $class; ?>" title="<?php echo esc_attr( sprintf( __( 'Ver todos os artigos em %s', 'hello-elementor-child' ), $categoria ) ); ?>">
	<?php echo $categoria; ?>
</a>
