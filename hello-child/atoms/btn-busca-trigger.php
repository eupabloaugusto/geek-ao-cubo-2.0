...
$placeholder = isset( $args['placeholder'] ) ? esc_html( $args['placeholder'] ) : __( 'Pesquisar no portal...', 'hello-elementor-child' );
?>

<button id="<?php echo $id; ?>" 
		class="btn-busca-trigger js-open-search-modal <?php echo $class; ?>" 
		type="button" 
		aria-label="<?php esc_attr_e( 'Abrir barra de pesquisa', 'hello-elementor-child' ); ?>"
