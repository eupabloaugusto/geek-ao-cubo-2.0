...
<button type="button" <?php echo $btn_id_attr; ?> class="<?php echo esc_attr( trim( $classes ) ); ?>" aria-label="<?php esc_attr_e( 'Alternar menu', 'hello-elementor-child' ); ?>" aria-expanded="<?php echo $is_active ? 'true' : 'false'; ?>">
