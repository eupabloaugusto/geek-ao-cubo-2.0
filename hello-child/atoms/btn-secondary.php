...
$label    = isset( $args['label'] ) ? esc_html( $args['label'] ) : __( 'Voltar', 'hello-elementor-child' );
$type     = isset( $args['type'] ) ? sanitize_key( $args['type'] ) : 'link';
...
<?php if ( $is_button ) : ?>
	<button type="<?php echo esc_attr( $type ); ?>"<?php echo $btn_id_attr; ?>
		class="btn btn--secondary <?php echo $class . $disabled_cls; ?>"
