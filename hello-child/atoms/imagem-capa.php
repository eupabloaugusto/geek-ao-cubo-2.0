...
$alt          = isset( $args['alt'] ) ? esc_attr( $args['alt'] ) : __( 'Capa de anime do blog Geek ao Cubo', 'hello-elementor-child' );
...
<div class="imagem-capa-container <?php echo $class; ?>">
	...
	<?php else : ?>
		...
		<div class="imagem-capa-placeholder" aria-label="<?php echo esc_attr( __( 'Capa não disponível', 'hello-elementor-child' ) ); ?>">
			<span class="imagem-capa-placeholder__text"><?php _e( 'Sem Imagem', 'hello-elementor-child' ); ?></span>
		</div>
	<?php endif; ?>
