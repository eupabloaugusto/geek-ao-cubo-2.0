...
$svg_map = array(
	'horizontal-01'  => 'logo-horizontal-01.svg',
	'horizontal-02'  => 'logo-horizontal-02.svg',
	'wordmark'       => 'logo-wordmark.svg',
	'icone-quadrado' => 'logo-icone-quadrado.svg',
	'icone-simples'  => 'logo-icone-simples.svg',
);
...
<div class="logo logo--<?php echo esc_attr( $variante ); ?><?php echo $classes; ?>" role="img" aria-label="<?php echo $alt; ?>">
	<?php if ( $com_link ) : ?>
