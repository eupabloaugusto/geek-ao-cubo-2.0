...
<div class="card-recomendacao">
	...
	<a href="<?php echo $anime_url; ?>" class="card-recomendacao__media" aria-label="<?php echo esc_attr( sprintf( __( 'Ver detalhes do anime recomendado %s', 'hello-elementor-child' ), $anime_title ) ); ?>">
		<?php
		mm_render_component( 'atoms', 'imagem-capa', array(
			'src' => $anime_image,
			'alt' => sprintf( __( 'Capa do anime: %s', 'hello-elementor-child' ), $anime_title ),
		) );
		?>
	</a>
