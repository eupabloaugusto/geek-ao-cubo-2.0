...
$score_label  = isset( $args['score_label'] ) ? esc_html( $args['score_label'] ) : __( 'Média', 'hello-elementor-child' );
$score_votes  = isset( $args['score_votes'] ) ? esc_html( $args['score_votes'] ) : '';

$rank         = isset( $args['rank'] ) ? esc_html( $args['rank'] ) : '';
$rank_label   = isset( $args['rank_label'] ) ? esc_html( $args['rank_label'] ) : __( 'Ranking', 'hello-elementor-child' );

$popularity   = isset( $args['popularity'] ) ? esc_html( $args['popularity'] ) : '';
$pop_label    = isset( $args['pop_label'] ) ? esc_html( $args['pop_label'] ) : __( 'Popularidade', 'hello-elementor-child' );

$members      = isset( $args['members'] ) ? esc_html( $args['members'] ) : '';
$members_label = isset( $args['members_label'] ) ? esc_html( $args['members_label'] ) : __( 'Membros', 'hello-elementor-child' );
