...
$horario_utc = isset( $args['horario_utc'] ) ? esc_html( $args['horario_utc'] ) : '';
...
$data_attr = ! empty( $horario_utc ) ? 'data-horario-utc="' . $horario_utc . '"' : '';
?>

<span class="badge-horario <?php echo $class; ?>" title="<?php echo esc_attr( sprintf( __( 'Episódio às %s', 'geek-ao-cubo' ), $horario ) ); ?>" <?php echo $data_attr; ?>>
