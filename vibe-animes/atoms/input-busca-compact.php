...
$placeholder = isset( $args['placeholder'] ) ? esc_attr( $args['placeholder'] ) : __( 'Pesquisar...', 'geek-ao-cubo' );
...
$aria_label  = isset( $args['aria_label'] ) ? esc_attr( $args['aria_label'] ) : __( 'Abrir pesquisa', 'geek-ao-cubo' );
?>
