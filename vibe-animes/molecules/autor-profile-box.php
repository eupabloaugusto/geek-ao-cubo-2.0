...
<div class="autor-profile-box <?php echo $class; ?>">
	...
	<div class="autor-profile-box__content">
		<span class="autor-profile-box__role-label"><?php _e( 'Autor do Artigo', 'geek-ao-cubo' ); ?></span>
		...
		<?php else : ?>
			<p class="autor-profile-box__bio autor-profile-box__bio--empty">
				<?php echo sprintf( __( '%s é colunista e apaixonado pelo universo de animes no Geek ao Cubo.', 'geek-ao-cubo' ), $author_name ); ?>
			</p>
		<?php endif; ?>
	</div>
</div>
