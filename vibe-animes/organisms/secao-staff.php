...
$titulo         = isset( $args['titulo'] )         ? esc_html( $args['titulo'] )        : __( 'Equipe de Produção', 'geek-ao-cubo' );
...
$ver_mais_label = isset( $args['ver_mais_label'] ) ? esc_html( $args['ver_mais_label'] ) : __( 'Ver equipe completa', 'geek-ao-cubo' );
...
foreach ( $staff as $member ) {
	...
	$group = ! empty( $member['role_group'] ) ? esc_html( $member['role_group'] ) : __( 'Outros', 'geek-ao-cubo' );
