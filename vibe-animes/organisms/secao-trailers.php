 ...
 * Com 1 vídeo: renderiza o atom embed-video diretamente dentro da seção.
 ...
 * @param string $args['titulo']      Título unificado da seção (ex: "Assista ao trailer" ou "Trailers e PVs")
 */
